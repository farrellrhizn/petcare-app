...
@section('title', 'Create Checkup - PetCare+')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-foreground">Create New Checkup</h1>
</div>
    ...
    <div class="p-6">
        <form action="{{ route('checkups.store') }}" method="POST">
            ...
            <div class="flex gap-3">
                <button type="submit" class="inline-flex items-center px-6 py-2.5 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors shadow-sm font-medium">Create Checkup</button>
